...
class Nomenclator:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Nomenclator', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/Nomenclator_modulo/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Nomenclator Toponìmic Valencià'),
            callback=self.run,
    ...
    def unload(self):
        ...
        #print "** UNLOAD Nomenclator"

        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Nomenclator Toponìmic Valencià'),
                action)
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = NomenclatorDockWidget()
